 ...
 * @author dmeng
 */
public class UiAppTemplate extends AbstractBBTemplateSection {

    public static final String SECTION_ID = "uiApp"; //$NON-NLS-1$
    ...
    public static final String HELP_CONTEXT_ID = "net.rim.ejde.doc.template_uiApp"; //$NON-NLS-1$

    public static final String PACKAGE_NAME = "mypackage"; //$NON-NLS-1$
    public static final String CLASS_NAME = "MyApp"; //$NON-NLS-1$
    public static final String SCREEN_NAME = "MyScreen"; //$NON-NLS-1$
    public static final String TITLE = "MyTitle"; //$NON-NLS-1$

    /**
     * Constructor for UiAppTemplate.
     */
    public UiAppTemplate() {
        setPageCount( 1 );
        createOptions();
    }
    ...
    private void createOptions() {
        ...
        addOption( KEY_SCREEN_CLASS_NAME, "&Screen Class Name:", SCREEN_NAME, 0 );
    ...
    public void validateOptions( TemplateOption changed ) {
        ...
        if( appClassName.equals( scrClassName ) ) {
            names.add( IConstants.EMPTY_STRING );
