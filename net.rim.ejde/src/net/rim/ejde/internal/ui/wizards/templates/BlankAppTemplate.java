...
/**
 * Blank BlackBerry Application template.
 *
 * @author dmeng
 */
public class BlankAppTemplate extends AbstractBBTemplateSection {

    public static final String SECTION_ID = "emptyApp"; //$NON-NLS-1$
    public static final String HELP_CONTEXT_ID = "net.rim.ejde.doc.template_blank"; //$NON-NLS-1$
    public static final String PACKAGE_NAME = "mypackage"; //$NON-NLS-1$
    public static final String CLASS_NAME = "MyApp"; //$NON-NLS-1$

    /**
     * Construct BlankAppTemplate.
     */
    public BlankAppTemplate() {
        setPageCount( 1 );
        createOptions();
    }
    ...
    public void addPages( Wizard wizard ) {
        ...
        page.setDescription( "This template will generate an empty BlackBerry application." );
        wizard.addPage( page );
        markPagesAdded();
    }
