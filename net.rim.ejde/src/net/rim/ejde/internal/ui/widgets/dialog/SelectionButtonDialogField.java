...
public class SelectionButtonDialogField extends DialogField {
    ...
    /**
     * Attaches a field to the selection state of the selection button. The attached field will be disabled if the selection
    ...
    /**
     * Attaches fields to the selection state of the selection button. The attached fields will be disabled if the selection
     * button is not selected.
     */
