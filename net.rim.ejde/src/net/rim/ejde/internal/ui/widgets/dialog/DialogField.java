...
/**
 * Base class of all dialog fields. Dialog fields manage controls together with the model, independed from the creation time of
 * the widgets. - support for automated layouting. - enable / disable, set focus a concept of the base class.
 *
...
public class DialogField {
     ...
     * <code>MGridLayout</code> as layout. The dialog field will adjust its controls' spans to the number of columns given. To be
     * reimplemented by dialog field implementors.
     */
    ...
    protected final boolean isOkToUse( Control control ) {
        boolean okToUse = ( control != null ) && ( Display.getCurrent() != null ) && !control.isDisposed();
        return okToUse;
    }
