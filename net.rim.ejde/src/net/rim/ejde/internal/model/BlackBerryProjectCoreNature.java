...
public class BlackBerryProjectCoreNature implements IProjectNature {
    static final public String NATURE_ID = "net.rim.ejde.BlackBerryProjectCoreNature"; //$NON-NLS-1$
