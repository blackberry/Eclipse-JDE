...
/**
 * InvalidInstallFolder
 */
public class InvalidInstallFolder extends CustomCodeRule
{
    ...
    public boolean evaluateRule() {
        ...
        if  (installationFoler.length()>maxLen) {
            ...
            } else if (!InstallerUtil.testFolderWriteability(folderFile)){ //test the writeability
                invalidFolder=true;
                ruleProxy.setVariable(_invalid_folder_msg, InstallerUtil.ERROR_FOLDER_NOT_WRITABLE);                
            }
        }
